...
`verify/flow_sim.py` mirrors every automation's business logic (patterns P1–P8, findings F1–F14 applied) and executes the canonical UAT scenario (UAT_VERIFICATION_PLAN steps 1–10) with 50 assertions grouped by delivery phase.
...
## Phase-by-phase verification (run 3)

| Phase | Asserts | Result | What it proves |
|-------|---------|--------|----------------|
| P0 shared core | 1 | ✅ | P1 independent counters (SO/RMWAD/RM) |
| P1 procurement | 9 | ✅ | RMWAD series, GST split (₹16,500/₹2,970/CGST-SGST ₹1,485/₹19,470), G5 fields (0/75/Not Started → 75/0/Complete), delayed stock posting (200→275), PO Fully Received, Delivery Days 5, movement log, QC |
| P2 SO→Costing→Plan | 9 | ✅ | SO ₹175,000; Section A 4 lines 275/125 kg = ₹103,000; sheet ₹146,000; chain creation (Revenue ₹175,000 at Project); Plan available 200/400, shortage 75 kg → auto-PR |
| P3 MR gate | 8 | ✅ | 4 components ₹144,000 (Sec E excluded); ratios 68.75/31.25; cross-val 400=400, +6% flag, +11% block; Project cost ₹144,000, P&L +₹31,000; MIS draft (header+lines, F5); SLA 2/2/1 hr |
| P4 production | 12 | ✅ | Post MIS → stock 0/275, Issued 275/125, 2 log rows; BMR 36.5/39.6 → 100/99.6; 80% + 100% alerts fired once; RC variance-only (C25); packing deducts packaging only; FGHM → FG +148/+300, `Fully Consumed` stays OFF (C29) |
| P5 site + inventory | 6 | ✅ | SCE 8a whole-submit rejected (103.6%); MRT credit (265/114.5, returned 10/10, stock 10/285); SCE 8c accepted (100%/95.6%); FG consumption → 0/20; min/max reorder fires |
...
| 2 costing | expandCosting, costingApproveChain, getAvailableStock, planReleaseAutoPR | ✅ 9/9 | ⏳ manual |
| 3 MR gate | mrDerive, crossValidate, mrReleaseAutoMIS, mrSlaSchedules | ✅ 8/8 | ⏳ manual |
| 4 production | postMIS, consumeAllocation, bmrSubmit, fghmAccept, packingDeduct | ✅ 12/12 | ⏳ manual |
| 5 site | sceSubmit, materialReturn, fgConsumption, inventoryAlerts | ✅ 6/6 | ⏳ manual |
| 7 UAT | — (sim IS the UAT run) | ✅ 5/5 | ⏳ console UAT + findings F10 |

**Loop complete — 50/50 green. Next:** paste into Zoho Creator (.in) per playbook phases; console-level items still open: F10 Blueprint auto-transition verify, Q1–Q9 clarifications, sender email verification.
